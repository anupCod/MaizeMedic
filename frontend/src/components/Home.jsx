        ...
        <section className='w-full flex justify-center my-12 z-2'>
            <form className='w-[26rem] h-[15rem] rounded-md shadow-neumorphism flex flex-col items-center justify-center bg-slate-100 px-5'>
                ...
                <div className='flex gap-8'>
                  ...
                  <input type="submit" value="Predict" className={`${loginStatus? 'block' :'hidden'} border-0 mt-5 px-4 py-[0.4rem] bg-primary font-semibold text-white rounded-md cursor-pointer`} />
                </div>
            </form>
        </section>
    </>
