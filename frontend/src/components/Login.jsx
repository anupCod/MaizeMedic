    ...
    <>
        <section className='min-w-full h-screen'>
            <form className='shadow-neumorphism w-[24rem] flex flex-col gap-3 p-7 my-8 mx-auto bg-white'>
                ...
                <input type="email" name="email" placeholder='Email' className='border-[1px]  border-secondary border-solid px-3 text-sm py-[0.6rem] rounded-md outline-none' />
                <input type="password" name="Password" placeholder='Password' className='border-[1px] border-secondary border-solid text-sm px-3 py-[0.6rem] rounded-md outline-none' />
